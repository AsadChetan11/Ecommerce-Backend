            ...
            <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                ...
                <li class="start ">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="index_2.html">
                                <i class=""></i> Background
                            </a>
                        </li>
                        <li>
                            <a href="index_2.html">
                                <i class=""></i> Install Plugins</a>
                        </li>
                        <li>
                            <a href="index_2.html">
                                <i class=""></i> Header Footer & Blocks</a>
                        </li>
                        <li>
                            <a href="index_2.html">
                                <i class=""></i> Theme Editor</a>
                        </li>
                    </ul>
                </li>
                <li class="start ">
                ...
                <li class="start ">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="your-profile.php">
                                <i class=""></i> Your Profile</a>
                        </li>
                    </ul>
                </li>
                <li class="start ">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="index_2.html">
                                <i class=""></i> site health</a>
                        </li>
                        <li>
                            <a href="index_2.html">
                                <i class=""></i> export parsonal data</a>
                        </li>
                        <li>
                            <a href="index_2.html">
                                <i class=""></i> erase parsonal data</a>
                        </li>
                    </ul>
                </li>
                <li class="start ">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="product-edit.php">
                                <i class="icon-pencil"></i> Product Edit</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="ui_bootstrap_growl.html">
                                <span class="badge badge-roundless badge-warning">new</span>Bootstrap Growl
                                Notifications</a>
                        </li>
                        <li>
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a href="form_controls_md.html">
                                <span class="badge badge-roundless badge-danger">new</span>Material Design<br> Form
                                Controls</a>
                        </li>
                        <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="page_coming_soon.html">
                                <i class="icon-flag"></i> Coming Soon</a>
                        </li>
                        <li>
                            <a href="page_blog.html">
                                <i class="icon-speech"></i> Blog
                            </a>
                        </li>
                        <li>
                            <a href="page_blog_item.html">
                                <i class="icon-link"></i> Blog Post</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="page_news_item.html">
                                <i class="icon-bell"></i> News View</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="extra_profile_old.html">
                                <i class="icon-user"></i> Old User Profile</a>
                        </li>
                    </ul>
                </li>
                <li>
